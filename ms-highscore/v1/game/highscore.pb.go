...
// 	protoc        v3.14.0
// source: ms-highscore/v1/highscore.proto
...
func (x *SetHighScoreRequest) Reset() {
	*x = SetHighScoreRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ms_highscore_v1_highscore_proto_msgTypes[0]
...
func (*SetHighScoreRequest) Descriptor() ([]byte, []int) {
	return file_ms_highscore_v1_highscore_proto_rawDescGZIP(), []int{0}
}
...
func (x *SetHighScoreResponse) Reset() {
	*x = SetHighScoreResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ms_highscore_v1_highscore_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SetHighScoreResponse) Descriptor() ([]byte, []int) {
	return file_ms_highscore_v1_highscore_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetHighScoreRequest) Reset() {
	*x = GetHighScoreRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ms_highscore_v1_highscore_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetHighScoreRequest) Descriptor() ([]byte, []int) {
	return file_ms_highscore_v1_highscore_proto_rawDescGZIP(), []int{2}
}
...
func (x *GetHighScoreResponse) Reset() {
	*x = GetHighScoreResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ms_highscore_v1_highscore_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetHighScoreResponse) Descriptor() ([]byte, []int) {
	return file_ms_highscore_v1_highscore_proto_rawDescGZIP(), []int{3}
}
...
var File_ms_highscore_v1_highscore_proto protoreflect.FileDescriptor

var file_ms_highscore_v1_highscore_proto_rawDesc = []byte{
	0x0a, 0x1f, 0x6d, 0x73, 0x2d, 0x68, 0x69, 0x67, 0x68, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x2f, 0x76,
	0x31, 0x2f, 0x68, 0x69, 0x67, 0x68, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	...
	0x68, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x16,
	0x5a, 0x14, 0x6d, 0x73, 0x2d, 0x68, 0x69, 0x67, 0x68, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x2f, 0x76,
	0x31, 0x2f, 0x67, 0x61, 0x6d, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_ms_highscore_v1_highscore_proto_rawDescOnce sync.Once
	file_ms_highscore_v1_highscore_proto_rawDescData = file_ms_highscore_v1_highscore_proto_rawDesc
)

func file_ms_highscore_v1_highscore_proto_rawDescGZIP() []byte {
	file_ms_highscore_v1_highscore_proto_rawDescOnce.Do(func() {
		file_ms_highscore_v1_highscore_proto_rawDescData = protoimpl.X.CompressGZIP(file_ms_highscore_v1_highscore_proto_rawDescData)
	})
	return file_ms_highscore_v1_highscore_proto_rawDescData
}

var file_ms_highscore_v1_highscore_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_ms_highscore_v1_highscore_proto_goTypes = []interface{}{
...
var file_ms_highscore_v1_highscore_proto_depIdxs = []int32{
...
func init() { file_ms_highscore_v1_highscore_proto_init() }
func file_ms_highscore_v1_highscore_proto_init() {
	if File_ms_highscore_v1_highscore_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_ms_highscore_v1_highscore_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ms_highscore_v1_highscore_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ms_highscore_v1_highscore_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ms_highscore_v1_highscore_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ms_highscore_v1_highscore_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_ms_highscore_v1_highscore_proto_goTypes,
		DependencyIndexes: file_ms_highscore_v1_highscore_proto_depIdxs,
		MessageInfos:      file_ms_highscore_v1_highscore_proto_msgTypes,
	}.Build()
	File_ms_highscore_v1_highscore_proto = out.File
	file_ms_highscore_v1_highscore_proto_rawDesc = nil
	file_ms_highscore_v1_highscore_proto_goTypes = nil
	file_ms_highscore_v1_highscore_proto_depIdxs = nil
}
...
var _Game_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "ms-highscore/v1/highscore.proto",
}
